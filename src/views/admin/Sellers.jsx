          ...
          <table className='w-full text-sm text-black border-b border-slate-950 text-left'>
            <thead>
              <tr>
                ...
                <th className='py-3 px-4' scope='col'>Devision</th>
                ...
                [1,2,3,4,5].map((d,i)=>{
                  return(
                    <tr key={i}>
                        ...
                        <td  className='py-3 px-4 whitespace-nowrap'>Bestie</td>
                        ...
                        <td  className='py-3 px-4 whitespace-nowrap'>2</td>
                        <td  className='py-3 px-4 whitespace-nowrap'>hello</td>
